        ...
        <form class="text-end" action="{{ $action }}">
            ...
            <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <input type="number" class="form-control" id="unit_masuk" name="unit_masuk"  value="{{ isset($data)?$data->unit_keluar:(session('unit') ? session('unit') : '') }}" placeholder="0">
                            </div>
                        </div>
                        <!-- harga -->
                        <div class="row mb-3">
                ...
                <div class="col">
                    <div class="d-flex justify-content-end mt-3 ">
                        ...
                        @if(!session('Multiple'))
                            ...
                            <a href="/stock"><button type="button" class="btn btn-warning mx-1">Kembali</button></a>
